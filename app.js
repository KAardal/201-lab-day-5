...
function sum(a,b){ //eslint-disable-line
  var values = [];
  var summed = a + b;
  var concat = ('The sum of ' + a + ' and ' + b + ' is ' + summed + '.');
  values.push(summed);
  values.push(concat);
  return values;
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  concat = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + summed + ' is their sum.';
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  product = multiply(multiply(testArray[0],testArray[1])[0], testArray[2])[0];
  concat = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + product + '.';
